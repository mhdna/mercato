...
SELECT id, financials_high_season_months, updated_at, activity_message_seconds, activity_display_mode, barcode_label_width, barcode_label_height FROM app_settings WHERE id = 1
`
...
SET financials_high_season_months = $1,
    ...
    updated_at = now()
WHERE id = 1
RETURNING id, financials_high_season_months, updated_at, activity_message_seconds, activity_display_mode, barcode_label_width, barcode_label_height
`
