...
const (
	...
	InventoryType_INVENTORY_TYPE_WAREHOUSE   InventoryType = 1
	InventoryType_INVENTORY_TYPE_STORE       InventoryType = 2
)
...
type Inventory struct {
	...
	Type          InventoryType          `protobuf:"varint,3,opt,name=type,proto3,enum=pb.InventoryType" json:"type,omitempty"`
...
func (x *Inventory) GetType() InventoryType {
	if x != nil {
		return x.Type
	}
...
const file_inventory_proto_rawDesc = "" +
	"\n" +
	"\x0finventory.proto\x12\x02pb\"Z\n" +
	"\tInventory\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\x12%\n" +
	"\x04type\x18\x03 \x01(\x0e2\x11.pb.InventoryTypeR\x04type*g\n" +
	"\rInventoryType\x12\x1e\n" +
	"\x1aINVENTORY_TYPE_UNSPECIFIED\x10\x00\x12\x1c\n" +
	"\x18INVENTORY_TYPE_WAREHOUSE\x10\x01\x12\x18\n" +
	"\x14INVENTORY_TYPE_STORE\x10\x02B\x1bZ\x19github.com/mhdna/kashi/pbb\x06proto3"
...
var file_inventory_proto_goTypes = []any{
	(InventoryType)(0), // 0: pb.InventoryType
	(*Inventory)(nil),  // 1: pb.Inventory
}
var file_inventory_proto_depIdxs = []int32{
	0, // 0: pb.Inventory.type:type_name -> pb.InventoryType
